...
object Strings {
    const val APP_NAME = "Check Pack"
    const val APP_NAME_FIRST_WORD = "Check"
    const val COMPANY_NAME = "CITECH"
    const val EMPTY_STRING = ""
    object English {
        const val FROM = "From"
        const val CHECKLIST = "Checklist"
        const val YOU_ARE_READY_TO_GO = "You are ready to go!"
        const val BACK = "Back"
        const val NEXT = "Next"
        ...
        const val SELECT_VACATION = "Select vacation"
